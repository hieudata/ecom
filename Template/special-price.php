...
<section id="special-price">
    <div class="container">
        <h4 class="font-rubik font-size-20">Sản phẩm</h4>
        <hr>
                ...
                <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                        <a href="<?php printf('%s?item_id=%s', 'product.php',  $item['item_id']); ?>"><img
                                ...
                                class="img-fluid " style="height: 250px; width:200px"></a>
                        <div class="text-center">
                            ...
                            <form method="post">
                                ...
                                if (in_array($item['item_id'], $in_cart ?? [])){
                                    ...
                                    echo '<button type="submit" name="top_sale_submit" class="btn color-second-bg text-light font-size-12">Thêm vào giỏ</button>';
                                }
                                ?>
                            </form>
                        </div>

<section id="banner-area" style="width: 98%; margin:auto">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, asperiores!</p>

                    <div class="slider-btn">
                        <button class="btn btn-1">Giảm 50K</button>
                        <button class="btn btn-2">Giảm 30%</button>
                    </div>
                </div>
            </div>
    ...
    <!-- <div class="owl-carousel owl-theme">
        <div class="item">
            <img src="../assets/banner.jpg" alt="Banner1">
        </div>
        <div class="item">
